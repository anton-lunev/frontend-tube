...
export interface YouTubePlaylistItem {
  ...
  snippet: {
    ...
    description: string;
    /**
     * A map of thumbnail images associated with the playlist item. For each object in the map, the key is the name of the thumbnail image,
     * and the value is an object that contains other information about the thumbnail.
     */
    thumbnails: YouTubeThumbnail;
    /**
     ...
     * that is included in the playlist as the playlist item.
     */
    resourceId: {
      /**
      ...
      kind: string;
      /**
       * If the snippet.resourceId.kind propertys value is youtube#video, then this property will be present and its value will contain
  ...
  /**
   * The contentDetails object is included in the resource if the included item is a YouTube video. The object contains additional
   * information about the video.
   */
  contentDetails: {
    /**
     * The ID that YouTube uses to uniquely identify a video. To retrieve the video resource,
     * set the id query parameter to this value in your API request.
     */
    videoId: string;
    /**
     * The time, measured in seconds from the start of the video, when the video should start playing.
     * (The playlist owner can specify the times when the video should start and stop playing when the video is played in the context
     ...
     * (The playlist owner can specify the times when the video should start and stop playing when the video is played in the context
     * of the playlist.) By default, assume that the video.endTime is the end of the video.
     */
    endAt: string;
    /**
  ...
  status: {
    /**
     * The playlist items privacy status. The channel that uploaded the video that the playlist item represents can set this value using
     * either the videos.insert or videos.update method.
     */
    privacyStatus: string;
  };
}
